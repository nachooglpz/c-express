...
class HTTPServerBridge {
    ...
    listen(port, callback) {
        console.log(`🔧 HTTP Bridge: Creating server on port ${port}`);
        ...
        console.log(`🔧 HTTP Bridge: Starting server...`);
        this.server.listen(port, () => {
            console.log(`C-Express server listening on port ${port}`);
            if (callback) {
                console.log(`HTTP Bridge: Calling startup callback`);
                callback();
            }
        });
